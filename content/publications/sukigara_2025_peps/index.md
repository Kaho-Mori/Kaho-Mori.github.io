...
2024年2月、西部亜熱帯北太平洋の定点観測ステーション KEO（32.5°N, 144.5°E）において、72時間にわたり3時間おきに水柱観測と採水を実施しました。短時間スケールの物理・化学場の変動が生物プロセスに与える影響を評価するため、CTD 観測および硝酸塩同位体比を含む複数の生地球化学パラメータを測定しました。

観測水塊は5タイプに分類され、植物プランクトンによる硝酸塩消費の昼夜変動（Type I）、成層・薄明帯境界での水塊混合（Type II）、混合層の急激な深化（Type III）、薄明帯からの短時間三次元湧昇（Type IV）、150m以深の安定した深層水（Type V）が確認されました。
